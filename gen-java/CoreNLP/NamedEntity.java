...
public class NamedEntity implements org.apache.thrift.TBase<NamedEntity, NamedEntity._Fields>, java.io.Serializable, Cloneable, Comparable<NamedEntity> {
  ...
  public int hashCode() {
    ...
    boolean present_endOffset = true;
    list.add(present_endOffset);
    if (present_endOffset)
      list.add(endOffset);

    boolean present_sentence_number = true;
    list.add(present_sentence_number);
    if (present_sentence_number)
      list.add(sentence_number);
  ...
  public int compareTo(NamedEntity other) {
    ...
    lastComparison = Boolean.valueOf(isSetSentence_number()).compareTo(other.isSetSentence_number());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetSentence_number()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.sentence_number, other.sentence_number);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
